#
#  A module for loading PGM files into Python and Displaying them using
#  QuickDraw
#
#  Functions for use outside of this module:
#    loadPGM(fname) -- returns an image
...
#  October 6, 2008
#
#  Created by Guilherme Simas (PGM)
#  August 29, 2018 
#
import sys
...
#
#  loadPGM: A function that loads the named image file from disk, and stores
...
#  magic number (P5) that marks the file as an ASCII PGM file.  This is 
...
#  pixel being represented by a number between 0 and 255
...
def loadPGM(fname):
  ...
  if (max != 255):
    sys.stderr.write("Warning: PGM file does not have a maximum value of 255.  Image may not be handled correctly.")
